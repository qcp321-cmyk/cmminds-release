...
import { X, Quote, ArrowRight, Zap, Target, BrainCircuit, Sparkles, UserCheck, ShieldCheck, Globe, Cpu, Layers, Fingerprint, Activity, Terminal, ShieldAlert } from 'lucide-react';
...
const VisionModal: React.FC<VisionModalProps> = ({ onClose, onAction }) => {
  return (
    <div className="fixed inset-0 z-[150] bg-black/98 backdrop-blur-3xl flex items-center justify-center p-0 sm:p-4 animate-in fade-in duration-500" onClick={onClose}>
        <div 
          className="bg-[#020202] border-x sm:border border-white/10 w-full max-w-7xl h-full sm:h-auto sm:max-h-[90vh] sm:rounded-[3.5rem] shadow-[0_0_150px_rgba(34,211,238,0.08)] relative overflow-hidden flex flex-col lg:flex-row"
          onClick={e => e.stopPropagation()}
        >
            {/* Header Mobile Title */}
            <div className="lg:hidden p-6 border-b border-white/5 flex justify-between items-center bg-black">
                ...
                <div className="relative z-10 flex-1 flex flex-col items-center">
                    ...
                    <div className="w-full space-y-8">
                        <div className="relative group mx-auto w-fit">
                            ...
                            <div className="relative w-48 h-56 lg:w-56 lg:h-64 rounded-[2rem] bg-gray-950 border border-white/10 overflow-hidden shadow-2xl">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <UserCheck className="w-24 h-24 text-white/5" />
                                </div>
                                <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black to-transparent text-center">
                                    <p className="text-[8px] font-black text-cyan-400 uppercase tracking-[0.4em] mb-1">Authorization: Level 01</p>
                        ...
                        <div className="text-center space-y-1">
                            <h2 className="text-3xl lg:text-4xl font-black text-white tracking-tighter uppercase italic leading-none">Aman Singh</h2>
                            <p className="text-[10px] font-mono tracking-[0.6em] uppercase text-gray-500">Master Architect</p>
                        </div>
                        ...
                        <div className="space-y-3 pt-4">
                            <div className="flex items-center justify-between p-4 bg-white/[0.02] border border-white/5 rounded-2xl">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Uplink</span>
                                </div>
                                <span className="text-[10px] font-bold text-white uppercase italic">Active</span>
                            </div>
                            <div className="flex items-center justify-between p-4 bg-white/[0.02] border border-white/5 rounded-2xl">
                                <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-bold text-white uppercase italic">Global Hub</span>
                            </div>
                            <div className="flex items-center justify-between p-4 bg-white/[0.02] border border-white/5 rounded-2xl">
                                <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-bold text-white uppercase italic">Synthesis</span>
                            </div>
                        </div>
                    </div>
                </div>

                <div className="relative z-10 pt-10 mt-auto flex flex-col items-center">
                    <div className="w-12 h-1 bg-cyan-500/20 rounded-full mb-4"></div>
                    <p className="text-[8px] font-mono tracking-[0.8em] text-gray-700 uppercase">Core Vision Node V4</p>
                </div>
            </div>

            {/* Right Column: The Manifesto (Content) */}
            <div className="flex-1 overflow-y-auto custom-scrollbar relative bg-[#010101]" data-lenis-prevent>
                ...
                <div className="p-8 lg:p-24 space-y-24 max-w-5xl relative z-10">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="relative">
                            <Quote className="absolute -top-16 -left-12 w-32 h-32 text-cyan-500/5 rotate-6" />
                            <h3 className="text-5xl lg:text-8xl font-black text-white leading-[0.9] tracking-tighter italic uppercase">
                                Killing <br/>
                        ...
                        <p className="text-xl lg:text-3xl text-gray-400 font-light leading-relaxed italic border-l-4 border-cyan-600 pl-8 lg:pl-12">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
                            {[
                                ...
                                <div key={i} className="p-8 lg:p-10 bg-white/[0.02] border border-white/5 rounded-[2.5rem] group hover:bg-white/[0.04] hover:border-white/10 transition-all">
                                    <div className="w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center mb-8 border border-white/5 group-hover:scale-110 transition-transform duration-500">
                                        <item.icon className="w-7 h-7 text-white/40 group-hover:text-white transition-colors" />
                                    </div>
                                    <h4 className="text-2xl font-black text-white uppercase italic tracking-tighter mb-4">{item.title}</h4>
                    ...
                    <div className="pt-24 border-t border-white/5 pb-16">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 bg-cyan-600/5 border border-cyan-500/10 p-10 lg:p-16 rounded-[3rem] relative overflow-hidden">
                            ...
                            <div className="space-y-4 text-center lg:text-left relative z-10">
                                <h4 className="text-4xl lg:text-5xl font-black text-white tracking-tighter uppercase italic leading-none">Initialize <span className="text-cyan-500">Sync?</span></h4>
                                <p className="text-xs lg:text-sm text-gray-500 uppercase tracking-[0.4em] font-black">Join the architectural elite.</p>
                            </div>
                            <button 
                                onClick={onAction}
                                className="w-full lg:w-auto px-16 py-8 bg-white text-black font-black rounded-full text-sm uppercase tracking-[0.4em] hover:bg-cyan-400 transition-all flex items-center justify-center gap-4 group shadow-[0_20px_60px_rgba(255,255,255,0.1)] active:scale-95 relative z-10"
                            >
                                Execute Protocol <ArrowRight className="w-6 h-6 group-hover:translate-x-3 transition-transform" />
                            </button>
                        </div>
                    </div>
                </div>
